...
public class Bot {
	...
	public void run(String path){
		...
		try{
			...
			new ReadingThread(msgQueue, hosebirdClient, twitter4jClient, participantNumber, CONF_FILE).start();
		}catch(Exception e){
